...
class GridworldEnv():
    ...
    def step_dp(self, obs, action):
        ...
        Execute a step with the agent in the Gridworld environment. Perform an action for a speficied state
...
class Random(GridworldEnv):
    # create a random quadratic grid with a given percentage of all cells covered by water/mountains
    def __init__(self, size=10, water=0.1, mountain=0.1):
        ...
        # set start
        self.grid[random.randint(0,size-1)][random.randint(0,size-1)] = 'S'
